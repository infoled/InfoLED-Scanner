...
class CcImage {
    ...
    init( array:inout [UInt8], width: Int, height: Int, bytesPerPixel:Int) {
        self.array = array
        self.width = width
        self.height = height
...
class CcLabel {
    ...
    static func labelImageFast(data: CcImage, calculateBoundingBoxes: Bool) -> LabelledData {
    ...
    private static func computeFinalData(finalLabels: [Int: Component], height: Int, width: Int,
    ...
    private static func getFinalLabels(labelMerges: inout [Int: Set<Int>]) -> [Int: Component] {
